        ...
        <form method="post" action="/orders/edit">
          <div class="mt-4 ml-4 mr-4">
            <div class="row border-bottom border-3">
              <div class="col"><h3 class="color-header text-uppercase">Edytuj zamówienie</h3></div>
            ...
            <form:form modelAttribute="orders">
              ...
              <table class="table borderless">
                ...
                <tr class="d-flex">
                  ...
                  <td class="col-7">
                    <form:select path="name" items="${ordersType}" multiple="false"></form:select>
                  </td>
                </tr>
                <tr class="d-flex">
                ...
                <tr class="d-flex">
                  ...
                  <td class="col-7">
                    <form:select path="status" items="${ordersStatus}" multiple="false"></form:select>
                  </td>
                </tr>
                <tr class="d-flex">
